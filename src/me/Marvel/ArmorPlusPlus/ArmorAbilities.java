	...
	public void obsidianArmor() {
		for(Player p : Bukkit.getOnlinePlayers()) {
				...
				if(name1.equalsIgnoreCase("Obsidian Helmet") && name2.equalsIgnoreCase("Obsidian Chestplate") && name3.equalsIgnoreCase("Obsidian Leggings") && name4.equalsIgnoreCase("Obsidian Boots")) {
					...
					if(lore1.equalsIgnoreCase(lore) && lore2.equalsIgnoreCase(lore) && lore3.equalsIgnoreCase(lore) && lore4.equalsIgnoreCase(lore)) {
						...
						if(Method.ifWearingAll(p, "Obsidian", lore)) {
							...
							m1.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.max_health", 20, Operation.ADD_NUMBER, EquipmentSlot.HEAD));
							m2.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.max_health", 20, Operation.ADD_NUMBER, EquipmentSlot.CHEST));
							m3.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.max_health", 20, Operation.ADD_NUMBER, EquipmentSlot.LEGS));
							m4.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.max_health", 20, Operation.ADD_NUMBER, EquipmentSlot.FEET));
			...
			try {
				...
				if(!Method.ifWearingAll(p, "Obsidian", ChatColor.GRAY + "Immovable")) Method.replaceArmorInInventory(p, "obsidian", newArmor);
			}catch(Exception e) {
		...
		for(Player p : Bukkit.getOnlinePlayers()) {
			try {
				...
				if(name1.equalsIgnoreCase("Emerald Helmet") && name2.equalsIgnoreCase("Emerald Chestplate") && name3.equalsIgnoreCase("Emerald Leggings") && name4.equalsIgnoreCase("Emerald Boots")) {
					...
					if(lore1.equalsIgnoreCase(checkLore) && lore2.equalsIgnoreCase(checkLore) && lore3.equalsIgnoreCase(checkLore) && lore4.equalsIgnoreCase(checkLore)) {
                         ...
                         * TO-DO AUTO-GENERATED BY ARMORCREATOR PROGRAM
						 */
						if(Method.ifWearingAll(p, "Emerald", checkLore)) {
							ItemStack armor1 = new ItemStack(Material.LEATHER_HELMET);
							ItemStack armor2 = new ItemStack(Material.LEATHER_CHESTPLATE);
							ItemStack armor3 = new ItemStack(Material.LEATHER_LEGGINGS);
							ItemStack armor4 = new ItemStack(Material.LEATHER_BOOTS);
							...
							m1.addAttributeModifier(Attribute.GENERIC_LUCK, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.luck", 3, Operation.ADD_NUMBER, EquipmentSlot.HEAD));
							m2.addAttributeModifier(Attribute.GENERIC_LUCK, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.luck", 3, Operation.ADD_NUMBER, EquipmentSlot.CHEST));
							m3.addAttributeModifier(Attribute.GENERIC_LUCK, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.luck", 3, Operation.ADD_NUMBER, EquipmentSlot.LEGS));
							m4.addAttributeModifier(Attribute.GENERIC_LUCK, new org.bukkit.attribute.AttributeModifier(UUID.randomUUID(), "generic.luck", 3, Operation.ADD_NUMBER, EquipmentSlot.FEET));
			...
			try {
				...
				if(!Method.ifWearingAll(p, "Emerald", ChatColor.DARK_GREEN + "Lucky - Greatly increases Fortune,")) {
					ItemStack[] newArmor = {armor1, armor2, armor3, armor4};
					Method.replaceArmorInInventory(p, "emerald", newArmor);
				}
			}catch(Exception e) {
